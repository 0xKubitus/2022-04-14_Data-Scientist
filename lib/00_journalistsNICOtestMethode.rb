...
def accueil
  puts "Salut ! Tu veux corriger quelle question ? (écris 'question1' si tu veux voir le résultat de la 1ère question)"
  print "> "
...
# 8) Sors-moi une répartition des handle par taille de ces derniers (nombre de handle avec 1 caractère, 
